import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Divider, Flex, HStack, Heading, IconButton, Text, useColorModeValue } from '@chakra-ui/react'
...
export default function FullWidthDoubleStack() {
  return (
    <>
      ...
      <HStack alignItems="center" spacing="4" h='16' p='3' borderBottom="1px" borderColor={useColorModeValue('gray.200', 'gray.600')}>
