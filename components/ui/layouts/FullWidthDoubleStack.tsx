...
export const FullWidthDoubleStackString = `import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, Divider, Flex, HStack, Heading, IconButton, Text, useColorModeValue } from '@chakra-ui/react'
import { Earth, User, UserPlus } from 'lucide-react'
  ...
  return (
    <>
      <Flex as="nav" alignItems="center" justifyContent="space-between" h='16' p='3' borderBottom="1px" borderColor={useColorModeValue('gray.200', 'gray.600')}>
        ...
        <HStack spacing="1">
          <IconButton variant="ghost" isRound={true} size="md" aria-label='earth icon'  icon={<Earth size="20" />}/>
      ...
      <Flex justifyContent="space-between" gap="4" h='16' p='3' borderBottom="1px" borderColor={useColorModeValue('gray.200', 'gray.600')}>
        ...
        <Button size="sm" leftIcon={<UserPlus size="20" />} colorScheme='blue'>New Project</Button>
      </Flex>
