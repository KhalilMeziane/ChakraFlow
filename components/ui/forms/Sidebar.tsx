					...
					>
						...
						>
							...
							<Text color="white">
								...
								adipisicing elit. Delectus eos aliquid, dicta,
								corrupti modi perspiciatis ad ducimus sunt quia
								temporibus nihil rem similique tempore corporis.
							</Text>
						</VStack>
					</VStack>
				</Box>
...
export const SidebarString = `"use client";
